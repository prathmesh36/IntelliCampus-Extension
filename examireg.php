        ...
        <div class="col-sm-offset-3 col-sm-5">
          <div class="form-box" >
            ...
            <div class="form-bottom" style="display:<?php if(($_GET['redirect'])=='reg'){echo'none';}?>;">
                <form role="form" action="login_reg_scripts/proreg_ex.php" method="post" class="registration-form">
                  ...
                  <div class="form-group">
                    <select name="course" style="font-family: 'Roboto', sans-serif;color: #888;font-size: 16px;height: 50px;font-weight: 300;line-height: 50px;">
                      <option value="AIT">AIT</option><option value="SWS">SWS</option><option value="DSA">DSA</option>
                    </select>
                  </div>
